...
//
//    service.setProcessor(paypalCreditCardProcessor)
//    service.setTransactionLog(databaseTransactionLog)
//
...
//    private lateinit var processor: PaypalCreditCardProcessor
//    private lateinit var transactionLog: DatabaseTransactionLog
//
//    fun chargeOrder(
//        order: PizzaOrder,
...
//    }
//
//    fun setProcessor(paypalCreditCardProcessor: PaypalCreditCardProcessor) {
//        this.processor = paypalCreditCardProcessor
//    }
//
//    fun setTransactionLog(databaseTransactionLog: DatabaseTransactionLog) {
//        this.transactionLog = databaseTransactionLog
//    }
// }
